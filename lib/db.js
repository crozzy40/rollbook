...
addColumn('tenancies', 'notify', "TEXT NOT NULL DEFAULT 'both'");         // both | email | sms | off
db.exec(`
...
CREATE TABLE IF NOT EXISTS messages (
  id          INTEGER PRIMARY KEY,
  kind        TEXT NOT NULL,          -- rent_due | rent_late | digest | report_alert | test
...
const DEFAULTS = {
  ...
  notify_email: '1',           // send email when it is set up
  notify_sms: '0',             // send texts when Twilio is set up
  notify_due: '0',             // "rent is due today"
  notify_late: '0',            // "rent is past due"
  notify_digest: '0',          // Monday summary to the owner
  notify_reports: '1',         // tell the owner when a tenant reports a repair
  notify_reports_when: 'urgent', // urgent | all
  notify_hour: '9',            // not before this hour, her time
  owner_email: '',
  owner_phone: '',
  from_email: '',
  sign_off: '',
